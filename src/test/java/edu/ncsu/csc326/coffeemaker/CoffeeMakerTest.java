...
public class CoffeeMakerTest {
	...
	public void testMakeCoffee() {
		...
		assertEquals(75, coffeeMaker.makeCoffee(Integer.MIN_VALUE,75));
		assertEquals(75, coffeeMaker.makeCoffee(Integer.MAX_VALUE,75));
		assertEquals(24, coffeeMaker.makeCoffee(0,24));
	...
	@Test
	public void deleteRecipeBadIndex() {
		coffeeMaker.addRecipe(recipe1);
		assertEquals(null, coffeeMaker.deleteRecipe(-1));
		assertEquals(null, coffeeMaker.deleteRecipe(4));
...
//
	...
	public void editRecipe() {
		coffeeMaker.addRecipe(recipe1);
		assertEquals(null, coffeeMaker.editRecipe(coffeeMaker.getRecipes().length-1, recipe2));
		assertEquals(null, coffeeMaker.editRecipe(Integer.MAX_VALUE, recipe2));
		assertEquals(null, coffeeMaker.editRecipe(Integer.MAX_VALUE, recipe2));
